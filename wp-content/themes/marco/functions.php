...
if ( ! function_exists( 'marco_setup' ) ) :
	...
	function marco_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'marco_custom_background_args', array(
...
function marco_scripts() {
	wp_enqueue_style( 'marco-style', get_stylesheet_uri() );

	wp_enqueue_script( 'marco-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'marco-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
